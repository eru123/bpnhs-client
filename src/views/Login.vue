        ...
        <v-layout align-center justify-center>
            <v-flex>
                <v-card max-width="400" class="mx-auto pa-4" flat>
                    ...
                    <v-card-text>
                        <v-form>
                        <v-text-field label="Username" prepend-icon="mdi-account-circle" v-model="user" />
                        <v-text-field 
                            type="password"
                            label="Password"
                            v-model="pass"
                    ...
                    <v-card-actions>
                        <v-btn color="primary" depressed block large rounded :loading="loading" @click="login">Login</v-btn>
                    </v-card-actions>
                </v-card>
            </v-flex>
        </v-layout>
